...
function init() {
  ...
  button2.position.x = 36; //* x축
  button2.position.y = 70; //* y축
  button2.position.z = 140; //* z축
...
function DrawThresholdChart() {
  ...
  let upperLimit = 10;
  let cmd =
    "https://idb.p-e.kr:5000/sensor?sensor=co2";
