...
class App {
    ...
    _setupLight() {
        ...
        const rectAreaLight = new THREE.RectAreaLight(0xffffff, 5, 20, 5);
        rectAreaLight.position.set(-5,20,0);
        rectAreaLight.lookAt(0,0,0);
        this._scene.add(rectAreaLight);

        // // Create a helper for the rect area light
        const rectAreaLightHelper = new THREE.PointLightHelper(rectAreaLight);
        this._scene.add(rectAreaLightHelper);
