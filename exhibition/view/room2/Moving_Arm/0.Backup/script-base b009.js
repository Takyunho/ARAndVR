...
class App {
    ...
    _loadModel() {
        ...
        loader.load('./assets/arm1.gltf', (gltf) => {
            ...
            this._gui.add(arm1.rotation, 'y', -0.5 * Math.PI, 0.5 * Math.PI, 0.01).name('arm1 Z');
        ...
        loader.load('./assets/arm2.gltf', (gltf) => {
            ...
            arm1.add(arm2);
            this._gui.add(arm2.rotation, 'x', -0.5 * Math.PI, 0.5 * Math.PI, 0.01).name('arm2 X');
        });
        ...
        loader.load('./assets/arm3.gltf', (gltf) => {
            ...
            arm2.add(arm3);
            this._gui.add(arm3.rotation, 'x', -0.5 * Math.PI, 0.5 * Math.PI, 0.01).name('arm3 X');
        });
        ...
        loader.load('./assets/arm4.gltf', (gltf) => {
            ...
            arm3.add(arm4);
            this._gui.add(arm4.rotation, 'x', -0.5 * Math.PI, 0.5 * Math.PI, 0.01).name('arm4 X');
        });
        ...
        loader.load('./assets/hand01.gltf', (gltf) => {
            ...
            arm4.add(hand01);
            this._gui.add(hand01.rotation, 'y', -0.5 * Math.PI, 0.5 * Math.PI, 0.01).name('hand Z');
        });
        ...
        loader.load('./assets/hand11L.gltf', (gltf) => {
            ...
            this._gui.add(hand11L.rotation, 'z', 0, 1.3, 0.01).name('hand y').onChange(() => {
                hand11R.rotation.z = -hand11L.rotation.z; //call back
