...
class App {
    ...
    _createTable() {
        ...
        const dum1Geometry = new THREE.BoxGeometry(); //test
    ...
    _setupLight() {
        ...
        Directlight1.lookAt(0, 15, 0);
        this._scene.add(Directlight1);

        const Directlight2 = new THREE.DirectionalLight(0xffffff, 0.1);
        Directlight2.position.set(-10, 10, -15);
        ...
        // Directlight1.shadow.camera.left = -200;
        // Directlight1.shadow.camera.right = 200;
        // Directlight1.shadow.camera.top = 200;
        // Directlight1.shadow.camera.bottom = -200
