...
class App {
    ...
    _loadModel() {
        ...
        new RGBELoader().load('./hdr221123/quattro_canti_4k.hdr', (texture) => {
            ...
            new GLTFLoader().load('./assets/Gen_MixerRoom_17a.gltf', (gltf) => {
    ...
    _createwall() {
        ...
        const wallMaterial1 = new THREE.MeshPhongMaterial({
            color: 0x909090
        });
