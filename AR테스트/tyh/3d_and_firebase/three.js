...
function init() {
  ...
  const createBtn = () => {
    ...
    // //^ 버튼 4
    // button4 = makeElementObject("div", 0.2, 0.2);
    // // con4ole.log("버튼 4 : ", button4)
    // button4.css3dObject.element.style.cursor = "pointer";
    // button4.scale.x = 0.05;
    // button4.scale.y = 0.1;
    // button4.scale.z = 0.001;    // 주변 흰색 테두리를 없애기 위함
    // button4.position.x = 1.8; //* x축
    // button4.position.y = 0.3; //* y축
    // button4.position.z = 1.15; //* z축
    // button4.css3dObject.element.className = "alarmDot";
    // button4.css3dObject.element.id = 'msg';
    // button4.css3dObject.element.style.background = new THREE.Color("#8d46b8").getStyle();
    // scene.add(button4);

    // button4.css3dObject.element.addEventListener("pointerdown", () => {
    //   console.log("버튼4 클릭");
