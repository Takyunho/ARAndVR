...
//# 첫번째 비디오
const ex_video = document.querySelector("#ex_video"); // video.js의 video
const a_video = document.querySelector("#a-video"); // a-video
//# 두번째 비디오
const ex_video2 = document.querySelector("#ex_video2");
const a_video2 = document.querySelector("#a-video2"); // a-video
